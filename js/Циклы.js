...
<<<<<<< HEAD
    console.log(i); /* последовательность цикла: единоразово инициализация, затем проверка условия и если true, затем тело цикла (то что в фигурных скобках)
=======
...
>>>>>>> f189c20440ca70aefe2162642ef92d3bc840b736
      после тела выполняется увеличения шага, проверка условия, снова тело, увеличение шага и тд. Пока условие будет правдиво этот цикл будет выполнять наши действия*/
}
...
<<<<<<< HEAD
    console.log(str[i] + '!');// [i] означает, что мы на каждой атерации будем получать в консоль один символ строки str и с ним мы можем что-то делать, например добавить восклиц. знак, и что угодно
    res += str[i] + '*'; // сложение с пустой строкой преобразует каждый символ в одну строку
=======
    console.log(str[i] + '!');
    res += str[i] + '*'; // [i] означает, что мы на каждой атерации будем получать в консоль один символ строки str и с ним мы можем что-то делать, например добавить восклиц. знак, и что угодно
>>>>>>> f189c20440ca70aefe2162642ef92d3bc840b736
}

let colors = ['white', 'black', 'yellow'];

for (let i = 0; i < colors.length; i++) { // Пример работы цикла с массивом
...
for (let i = 0; i < 10; i++) {
    if (i ===5) {
<<<<<<< HEAD
        continue;// с continue цикл переходит к следующей итерации при условии, что i === 5, при этом эту итерацию пропускает
=======
...
} // Создание объекта с именем на текущей итерации = users[i];
=======
for (let i = 0; i < users.length; i++) 
{
